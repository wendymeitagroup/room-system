...
export const sendEmail = async (req, res) => {
    ...
    const receivers = [selectedApplicantEmail, ...selectedAttendeesEmail];

    //寄信給申請者和所有與會者
    const transporter = nodemailer.createTransport({
        host: 'smtp.gmail.com', //SMTP 伺服器名稱 smtp.mail.meita.com.tw mail.meita.com.tw 59.124.136.138
        port: 587,              //SMTP 伺服器端口號碼             
        secure: false,          //是否使用加密連線 TLS
        auth: {
            user: 'wendymeitagroup@gmail.com', //寄件者email
            pass: 'lbbt onvx aufz zivy'        //寄件者密碼
        },
        tls: {
    ...
    //郵件選項
    const mailOptions = {
        from: "wendymeitagroup@gmail.com", //寄件者email:公用信箱 noreply@meita.com.tw
        to: receivers.join(', '),          //收件者email:申請者和所有與會者的email
        subject: subject,                  //郵件標題 會議主題
        text: content,                     //郵件內容
    };
